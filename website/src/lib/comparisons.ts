...
const svar: Comparison = {
  ...
  tagline: 'SVAR Svelte DataGrid (wx-svelte-grid) is a Svelte-native data grid component from the SVAR / XB Software team.',
  oneLineVerdict:
    "SVAR is another genuinely Svelte-native grid, so the deciding factors are licensing and architecture: SvGrid's core is MIT and headless-first with an MCP server, while SVAR is offered under GPL with a separate commercial license.",
  intro: [
    'SVAR DataGrid is part of the SVAR suite of Svelte components and is one of the few grids actually built for Svelte rather than wrapped from another framework. It provides sorting, filtering, editing, tree data, and a themeable component.',
    'SvGrid overlaps heavily on the Svelte-native angle. The practical differences are licensing - SvGrid ships an MIT community core, while SVAR is dual-licensed under GPL plus a commercial option - and SvGrid\'s headless engine, Excel-style filter menu, and sv-grid-mcp server.',
  ],
  similarities: [
    'Purpose-built for Svelte, not a wrapper.',
    'Full component with sorting, filtering, and editing.',
    'Tree / hierarchical data.',
    'Themeable.',
  ],
  svgridAdvantages: [
    'MIT-licensed community core - no GPL obligations for closed-source apps.',
    'Headless engine you can compose, in addition to the render component.',
    'Excel-style filter menu and cell-range selection built in.',
    'sv-grid-mcp MCP server for AI assistants.',
    'Pro pack for export, import, pivot, and AI.',
  ],
  competitorAdvantages: [
    'Part of a broader SVAR component suite (Gantt, scheduler, and more).',
    'Established team with DHTMLX lineage.',
    'Commercial license and support available.',
  ],
  features: [
    { feature: 'Svelte native', svgrid: '✅', competitor: '✅' },
    { feature: 'License', svgrid: '✅ MIT core', competitor: '⚠️ GPL + commercial', svgridBetter: true },
    { feature: 'Headless engine', svgrid: '✅', competitor: '⚠️ Component-first' },
    { feature: 'Excel-style filter menu', svgrid: '✅', competitor: '⚠️ Basic filtering' },
    { feature: 'Cell-range selection + copy', svgrid: '✅', competitor: '⚠️ Limited' },
    { feature: 'Virtualization', svgrid: '✅', competitor: '✅' },
    { feature: 'Tree data', svgrid: '✅', competitor: '✅' },
    { feature: 'AI / MCP integration', svgrid: '✅', competitor: '❌', svgridBetter: true },
  ],
  whenToChooseSvGrid: [
    'You want an MIT-licensed core with no GPL obligations.',
    'You want a headless engine plus a render component, not component-only.',
    'You want Excel-style filtering and an MCP server for AI tooling.',
  ],
  whenToChooseCompetitor: [
    'You are already adopting the wider SVAR suite (Gantt, scheduler).',
    'GPL or a SVAR commercial license fits your distribution model.',
    'You prefer a component-first API over a headless core.',
  ],
  migrationSlug: 'migrating-from-svar-svelte-datagrid',
  bottomLine:
    'Both are genuinely Svelte-native, so the call usually comes down to licensing: the SvGrid core is MIT with no copyleft, while SVAR is GPL plus a commercial option. If you are already in the SVAR suite, staying put is reasonable; otherwise the MIT core and headless engine of SvGrid are the edge.',
  faq: [
    { question: 'SvGrid vs SVAR Svelte DataGrid - what is the difference?', answer: 'Both are Svelte-native. The main differences are licensing (SvGrid MIT core vs SVAR GPL plus commercial) and architecture (SvGrid adds a headless engine and an MCP server).' },
    { question: 'Is SvGrid MIT-licensed unlike SVAR?', answer: 'Yes - sv-grid-community is MIT, with no GPL obligations for closed-source apps. SVAR is dual-licensed under GPL plus a commercial license.' },
    { question: 'Are both built for Svelte 5?', answer: 'Yes, both are Svelte-native rather than wrappers. Check the current SVAR docs for exact API and license terms.' },
  ],
}
