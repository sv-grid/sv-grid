// Curated feature/demo highlights for the tweet rotation. Hand-written so the
// brand voice stays controlled. Keep copy on SvGrid's own terms - no rival-grid
// vendor names, no em-dashes (repo-wide rules). Rotated one step per day.
export const HIGHLIGHTS = [
  {
    id: 'kanban', eyebrow: 'Board mode',
    ...
    link: 'https://svgrid.com/docs/help/rows/kanban-board', footerRight: 'Kanban board mode',
  },
  {
    id: 'virtualization', eyebrow: 'Performance',
    ...
    link: 'https://svgrid.com/docs/help/headless/virtualization', footerRight: 'Virtualized rendering',
  },
  {
    id: 'filters', eyebrow: 'Filtering',
    ...
    link: 'https://svgrid.com/docs/help/filtering/overview', footerRight: 'Excel-style filters',
  },
  {
    id: 'editing', eyebrow: 'Editing',
    ...
    link: 'https://svgrid.com/docs/help/editing/overview', footerRight: 'Inline cell editing',
  },
  {
    id: 'headless', eyebrow: 'Architecture',
    ...
    link: 'https://svgrid.com/docs/help/headless/overview', footerRight: 'Headless architecture',
  },
  {
    id: 'themes', eyebrow: 'Theming',
    ...
    hashtags: ['Svelte', 'CSS'],
    link: 'https://svgrid.com/docs/getting-started/5-theme-and-density', footerRight: 'Themeable by design',
  },
  {
    id: 'export', eyebrow: 'Export',
    ...
    hashtags: ['Svelte', 'DataGrid'],
    link: 'https://svgrid.com/docs/help/export', footerRight: 'Data export',
  },
  {
    id: 'charts', eyebrow: 'Charts',
    ...
    link: 'https://svgrid.com/docs/help/charts', footerRight: 'Integrated charts',
  },
  {
    id: 'server', eyebrow: 'Data',
    ...
    link: 'https://svgrid.com/docs/help/server-side-data', footerRight: 'Server data source',
  },
  {
    id: 'a11y', eyebrow: 'Accessibility',
    ...
    link: 'https://svgrid.com/docs/help/accessibility', footerRight: 'Accessible by default',
  },
]
