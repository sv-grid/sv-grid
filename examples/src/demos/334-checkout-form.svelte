...
<style>
  ...
  .card { display: flex; flex-direction: column; gap: 14px; padding: 20px; border: 1px solid var(--sg-border, #e6e8ec); border-radius: 14px; background: var(--sg-bg, #fff); box-shadow: 0 1px 2px rgba(15,23,42,0.05); }
  ...
  .txt { padding: 8px 11px; font: inherit; font-size: 14px; border: 1px solid var(--sg-input-border, var(--sg-border, #e6e8ec)); border-radius: 9px; background: var(--sg-input-bg, var(--sg-bg, #fff)); color: var(--sg-fg, inherit); }
  ...
  .total { display: flex; align-items: center; justify-content: space-between; padding: 12px 0; border-top: 1px dashed var(--sg-border, #e6e8ec); font-size: 13.5px; color: var(--sg-muted, #64748b); }
  .total strong { display: inline-flex; width: 130px; }
