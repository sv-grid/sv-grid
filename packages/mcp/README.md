...
| Tool | Purpose |
| --- | --- |
| `svgrid_search` | Search the docs, all 400+ demos and the API surface **in one call**. No arguments returns an index. |
...
400+ demos in this repo, which is what a CI test asserts. A verifier that cries
