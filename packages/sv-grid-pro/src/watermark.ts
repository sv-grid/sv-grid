// Soft-gate UX for unlicensed sv-grid-pro use. Shows a small clickable
...
const NUDGED_ATTR = 'data-sv-grid-pro-nudged'
...
function showConsoleOnce(): void {
  ...
  console.log(
    '%c sv-grid-pro %c User is using a Commercial version which requires a license.\n' +
...
function buildWatermark(kind: 'grid' | 'fixed'): HTMLAnchorElement {
  ...
  a.title =
    'Unlicensed sv-grid-pro. Contact sales@jqwidgets.com or visit www.svgrid.com.'
  return a
}
