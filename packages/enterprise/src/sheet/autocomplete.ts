...
export const SIGNATURES: Record<string, string> = {
  ...
  VLOOKUP: 'VLOOKUP(lookup, table, colIndex, [rangeLookup])',
  HLOOKUP: 'HLOOKUP(lookup, table, rowIndex, [rangeLookup])',
  XLOOKUP: 'XLOOKUP(lookup, haystack, results, [ifMissing], [matchMode], [searchMode])',
