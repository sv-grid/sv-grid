...
export class SvGridComponent implements OnInit, OnChanges, OnDestroy {
  ...
  @Input() processCellForFill?: unknown
  @Input() processCellForClipboard?: unknown
  @Input() includeCollapsedRows?: unknown
  @Input() clipboardHtml?: unknown
  @Input() processCellFromClipboard?: unknown
  @Input() enableInlineEditing?: boolean
  @Input() editOnSecondClick?: boolean
  ...
  @Input() showDetailToggle?: boolean
  @Input() isDetailOpen?: unknown
  @Input() hasDetail?: unknown
  @Input() serverGroup?: unknown
  @Input() serverFilterValues?: unknown
  @Input() pinnedTopRows?: readonly unknown[]
  @Input() frozenRows?: number
  @Input() stickyGroupRows?: boolean
  @Input() mergedCells?: readonly unknown[]
  ...
  @Output() columnresize = new EventEmitter<unknown>()
  @Output() rowresize = new EventEmitter<unknown>()
  @Output() pasteclipboard = new EventEmitter<unknown>()
