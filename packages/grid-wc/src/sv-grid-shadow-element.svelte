<svelte:options
  customElement={{
    ...
    props: {
      ...
      editOnSecondClick: { type: 'Boolean', attribute: 'edit-on-second-click' },
      ...
      rowPlaceholder: { type: 'Object' },
      rowModel: { type: 'Object' },
      pivotResultColumns: { type: 'Array' },
      rowSelectionModel: { type: 'Object' },
      isDetailRow: { type: 'Object' },
      detailRowHeight: { type: 'Number', attribute: 'detail-row-height' },
      showDetailToggle: { type: 'Boolean', attribute: 'show-detail-toggle' },
      isDetailOpen: { type: 'Object' },
      hasDetail: { type: 'Object' },
