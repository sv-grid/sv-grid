...
For the import built step by step on inline text, then through the dialog, see [Import: a spreadsheet into the grid](./export/import-spreadsheet.md); this page is the reference.
