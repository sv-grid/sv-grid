...
![The generator emits a message catalog and a locale switcher, and routes nav labels, screen titles, the New button, and grid column headers through a reactive t() translator so flipping the switcher re-renders the whole app.](/docs-media/studio-i18n.svg)
