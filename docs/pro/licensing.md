...
The `sv-grid-pro` package is **soft-gated**: every feature runs
...
expose the key as `VITE_SVPRO_KEY=SVPRO-...` in your `.env` (NOT
checked in) - or read it from your config service.

## License tiers

Every Pro license is a **perpetual license** that includes **1 year of
...
> `sv-grid-pro`. Production seats / end users are unlimited. One license key
...
```
SVPRO-IXIX-XXXX-XXXX-XXXX-XXXX
       │
...
- [Pro evaluation](./evaluation.md) - 30-day evaluation flow
- [Pro support](./support.md) - SLAs, escalation, contact channels
