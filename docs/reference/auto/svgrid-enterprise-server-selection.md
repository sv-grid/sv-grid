# `@svgrid/enterprise` · `server/server-selection.ts`

Auto-generated. Source: `packages\enterprise\src\server\server-selection.ts`.
...
### `function createServerSelectionModel`
