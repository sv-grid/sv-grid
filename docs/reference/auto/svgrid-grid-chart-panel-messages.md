# `@svgrid/grid` · `chart-panel-messages.ts`

Auto-generated. Source: `packages\grid\src\chart-panel-messages.ts`.
...
### `const defaultChartPanelMessages`
...
### `function resolveChartPanelMessages`
