# `@svgrid/enterprise` · `server/server-row-model.ts`

Auto-generated. Source: `packages\enterprise\src\server\server-row-model.ts`.
...
### `const GROUP_TOTAL_ROW_ID_PREFIX`
