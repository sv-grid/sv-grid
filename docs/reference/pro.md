...
Everything that `sv-grid-pro` adds on top of the Community surface.
Install + license: see [Pro feature pack](../pro/README.md).
...
Call once at app startup. Without a key the Pro methods still work
...
If you don't want to install Pro onto the api, use the module-level
helpers directly:
